...
TEXTS = {
    "ru": {
        ...
        "routing_ips": "🔢 IP/CIDR",
        "routing_rulesets": "📦 SRS Rule Sets",
        ...
        "ask_domain": "Введите домен(ы) через запятую (например: youtube.com, youtu.be):",
        "ask_ip": "Введите IP/CIDR через запятую (например: 8.8.8.8/32, 1.1.1.0/24):",
        "ask_ruleset_url": "Введите URL SRS файла (.srs бинарный или .json source):\nПример: https://github.com/SagerNet/sing-geosite/releases/download/20250101/geosite-youtube.srs",
    ...
    "en": {
        ...
        "ask_domain": "Enter domain(s), comma-separated (e.g.: youtube.com, youtu.be):",
        "ask_ip": "Enter IP/CIDR, comma-separated (e.g.: 8.8.8.8/32, 1.1.1.0/24):",
        "ask_ruleset_url": "Enter SRS URL (.srs binary or .json source):\nExample: https://github.com/SagerNet/sing-geosite/releases/download/20250101/geosite-youtube.srs",
